...
class DebugWindow(QWidget):
    ...
    def __init__(self):
        ...
        self._description = TextBlockLabel("This is a debug menu for working with the application. Please do not use these buttons unless you know what you are doing.")
        self._action_clear_settings = QPushButton("Clear Application Settings")
        self._action_clear_settings.setToolTip("Resets application settings. You must restart the application afterwards.")
